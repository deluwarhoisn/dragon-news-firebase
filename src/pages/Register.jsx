    ...
    return (
      ...
      <form onSubmit={handleRegister} className="card-body">
        <fieldset className="fieldset">
          {/* name */}
             <label className="label font-bold" name="name"> Your Name</label>
          <input type="email" className="input" placeholder="Enter your name" />
          {/* photo */}
           <label className="label font-bold" name="photo">Photo URL</label>
          <input type="email" className="input" placeholder="Enter your password" />
            {/* email */}
          <label className="label font-bold" name="email">Email</label>
          <input type="email" className="input" placeholder="Email" required/>

          {/* password */}
          <label className="label font-bold" name="password">Password</label>
